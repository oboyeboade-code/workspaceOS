...
router.post(
  ...
  UserController.forgotPassword("employer")
);
router.post(
  "/forgot-password-employee",
  authLimiter,
  validate(forgotPasswordSchema),
  UserController.forgotPassword("employee")
);
router.post(
  "/reset-password-employer",
  authLimiter,
  validate(resetPasswordSchema),
  UserController.resetPassword("employer")
);
router.post(
  "/reset-password-employee",
  authLimiter,
  validate(resetPasswordSchema),
  UserController.resetPassword("employee")
);
...
router.put(
  "/employer/role-salaries",
  protect,
  requireRole("employer"),
  validate(updateRoleSalariesSchema),
  UserController.updateRoleSalaries
);
